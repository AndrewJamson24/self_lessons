...
def Cezar_e():
    ...
    string_input = (input("introduceti mesajul: ")).upper().replace(" ", "")
...
def Cezar_word_e():
    clear_text = input("introduceti mesajul: ").upper().replace(" ", "")
    valid_letters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
    user_key = input("introduceti cuvantul cheie : ").upper().replace(" ", "")
    key = ""
